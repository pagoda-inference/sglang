...
def prewarm_dp_attention_memcpy(
    ...
    # DP ranks pass zero-dimensional views into global_num_tokens_gpu. Their
    # pointer alignment is part of Triton's specialization key, so cover the
    # aligned/unaligned combinations produced by per-rank views.
